...
class UsuariosRoutes {
  ...
  config(): void {
    ...
    this.router.get("/contactos2/:id", usuariosController.listContacts2);
    this.router.get(
      "/contactos/:id/:id_contacto",
      usuariosController.listOneContact
    );
    this.router.post(
      "/contactos/nuevo_contacto/:id/:id_contacto",
      usuariosController.newContact
    );
    this.router.put(
      "/contactos/actualizar_contacto/:id/:id_contacto",
      usuariosController.updateContact
    );
    this.router.delete(
      "/contactos/eliminar_contacto/:id/:id_contacto",
      usuariosController.deleteContact
    );
  }
}
